...
export const I18N: Record<Lang, any> = {
  en: {
    ...
    homeMethodology: {
      tag: "§01 · Methodology",
      headlinePre: "Nine signals,",
      headlineIt: "one",
      headlinePost: "grade.",
      subhead: "Three weighted tiers · continuous sampling · anchored to published research.",
      l1Label: "L1 · Trust",
      l1d1: "Model authenticity",
      l1d2: "Billing transparency",
      l1d3: "Cache fraud",
      l3Label: "L3 · Economics",
      l3d1: "List pricing",
      l3d2: "vs Official",
      l3d3: "Hidden cost",
      l2Label: "L2 · Performance",
      l2d1: "Latency · p95/p99",
      l2d2: "Throughput",
      l2d3: "Long-context decay",
      formulaLabel: "Overall",
      formula: "0.4·L1 + 0.4·L3 + 0.2·L2",
      tiersLabel: "Grade",
      link: "Full methodology",
      heroStripRouters: "routers",
      heroStripModels: "frontier models",
      heroStripSamples: "samples",
    },
    footer: {
      tagline:
    ...
    ranking: {
      ...
      thLatency: "p50 / p95",
      thAction: "Action",
      thScoreHint: "Composite score (0.4·L1 + 0.4·L3 + 0.2·L2), mapped to AAA → C.",
      thCostHint: "Observed price per 1M tokens — input / output shown separately.",
      thSuccessHint: "Share of probes that returned cleanly within the SLA window.",
      thLatencyHint: "p50 = median completion time. p95 = the slowest 5% tail.",
    ...
    provider: {
      ...
      tagIncidents: "§04 · Recent incidents",
      noIncidents: "No incidents in the past 7 days.",
      sevHigh: "high",
      sevMed: "medium",
      sevLow: "low",
      tagFingerprint: "§03 · Model fingerprint",
      ...
      recoveryMin: "{n}m",
      // CostSection
      noModelPricing: "No per-model pricing data published for this router.",
      costSummaryPre: "{name} covers {n} models · listed avg",
      costSummaryMid: "vs official · observed avg",
      costSummaryPost: "vs listed.",
      billingClean: "Billing clean · L1.2",
      billingMinor: "Minor drift · L1.2",
      billingConcern: "Concerning · L1.2",
      previewChip: "Preview",
      officialPrice: "Official",
      colModel: "Model",
      colOfficial: "Official (in/out)",
      colListed: "Listed (in/out)",
      colObserved: "Observed (in/out)",
      colObservedNote: "WHAT YOU ACTUALLY PAY",
      colOfficialShort: "Official",
      colListedShort: "Listed",
      colObservedShort: "Observed",
      selectModel: "Model",
      observedFootnote: "Observed prices · ~{samples} samples over past {window} (mock)",
      costAnalyzerTitle: "Cost analyzer",
      // TopMetrics
      mTtft: "TTFT (p50)",
      mTtftSub: "p95 {ms}ms",
      // ScoreSidebar
      sidebarScoreLabel: "Overall score",
      sidebarRecent7d: "Last 7d",
      sidebarNoEvents: "No events",
      sidebarEventsCount: "{n} event(s)",
      sidebarFormula: "Formula",
      // PerformanceSection
      tagPerformance: "§02 · Performance (L2)",
      headPerformance: "TTFT, throughput, long-context decay",
      perfSummary: "All latency tiles below are TTFT (time-to-first-token) percentiles · based on ~{samples} probes over past 7 days.",
      perfP50: "p50 TTFT",
      perfP50Hint: "Median time-to-first-token across recent probes. The 'typical' first-byte delay you can expect — drives chat / streaming UX.",
      perfP95: "p95 TTFT",
      perfP95Hint: "95th-percentile time-to-first-token — the slowest 5% of starts. Your tail-end first-byte experience under load.",
      perfP99: "p99 TTFT",
      perfP99Hint: "99th-percentile time-to-first-token — true worst-case first-byte latency. Critical for SLA and agent loops.",
      perfSuccess: "Success",
      perfSuccessHint: "Share of probes returning a non-empty response within the SLA window.",
      perfTrend7d: "7-day p50 TTFT trend",
      perfTrendUnit: "milliseconds",
      perfTrendHover: "Hover for daily value",
      trendRange: "7d range",
      trendToday: "today",
      trendDaysAgo: "{n}d ago",
      perfRegional: "Regional p50 TTFT",
      perfThroughput: "Throughput (tok/s)",
      perfThroughputNote: "Requires concurrent load testing · T2 roadmap",
      perfLongContext: "Long-context decay",
      perfLongContextNote: "Requires quality eval pipeline · T2 roadmap",
    },
  ...
  zh: {
    ...
    homeMethodology: {
      ...
      tiersLabel: "评级",
      link: "完整方法论",
      heroStripRouters: "中转站",
      heroStripModels: "前沿模型",
      heroStripSamples: "次采样",
    },
    footer: {
      tagline:
    ...
    ranking: {
      ...
      thLatency: "p50 / p95",
      thAction: "操作",
      thScoreHint: "综合分(0.4·L1 + 0.4·L3 + 0.2·L2),映射为 AAA → C。",
      thCostHint: "每 100 万 token 的观测价格,输入 / 输出分别展示。",
      thSuccessHint: "探测请求中在 SLA 窗口内正常完成的占比。",
      thLatencyHint: "p50 = 完成时间中位数;p95 = 最慢 5% 的尾部延迟。",
      insightCheapest: "最便宜",
    ...
    provider: {
      ...
      tagIncidents: "§04 · 近期事件",
      noIncidents: "过去 7 天无事件。",
      sevHigh: "高",
      sevMed: "中",
      sevLow: "低",
      tagFingerprint: "§03 · 模型指纹",
      ...
      recoveryMin: "{n} 分钟",
      // CostSection
      noModelPricing: "该路由器未公布各模型的逐项定价。",
      costSummaryPre: "{name} 涵盖 {n} 个模型 · 明面均价",
      costSummaryMid: "vs 官方 · 观测均价",
      costSummaryPost: "vs 明面价。",
      billingClean: "计费正常 · L1.2",
      billingMinor: "轻微漂移 · L1.2",
      billingConcern: "计费异常 · L1.2",
      previewChip: "预览",
      officialPrice: "官方",
      colModel: "模型",
      colOfficial: "官方 (输入/输出)",
      colListed: "明面 (输入/输出)",
      colObserved: "观测 (输入/输出)",
      colObservedNote: "你实际支付的",
      colOfficialShort: "官方",
      colListedShort: "明面",
      colObservedShort: "观测",
      selectModel: "模型",
      observedFootnote: "观测价格 · 过去 {window} 约 {samples} 次采样（mock）",
      costAnalyzerTitle: "成本分析器",
      // TopMetrics
      mTtft: "TTFT (p50)",
      mTtftSub: "p95 {ms}ms",
      // ScoreSidebar
      sidebarScoreLabel: "综合分",
      sidebarRecent7d: "近 7 天",
      sidebarNoEvents: "无事件",
      sidebarEventsCount: "{n} 个事件",
      sidebarFormula: "公式",
      // PerformanceSection
      tagPerformance: "§02 · 性能 (L2)",
      headPerformance: "TTFT、吞吐量、长上下文衰减",
      perfSummary: "以下延迟卡片均为 TTFT（首 token 时间）百分位 · 基于过去 7 天约 {samples} 次探测。",
      perfP50: "p50 TTFT",
      perfP50Hint: "近期探测的首 token 时间中位数。你可以预期的「典型」首字节延迟——直接影响聊天 / 流式体验。",
      perfP95: "p95 TTFT",
      perfP95Hint: "95th 百分位首 token 时间——最慢 5% 的启动延迟。负载下的尾部首字节体验。",
      perfP99: "p99 TTFT",
      perfP99Hint: "99th 百分位首 token 时间——真正的最坏情况首字节延迟。对 SLA 与 agent 循环至关重要。",
      perfSuccess: "成功率",
      perfSuccessHint: "在 SLA 窗口内返回非空响应的探测占比。",
      perfTrend7d: "7 天 p50 TTFT 趋势",
      perfTrendUnit: "毫秒",
      perfTrendHover: "悬停查看每日值",
      trendRange: "7 天范围",
      trendToday: "今天",
      trendDaysAgo: "{n} 天前",
      perfRegional: "分地域 p50 TTFT",
      perfThroughput: "吞吐量 (tok/s)",
      perfThroughputNote: "需要并发负载测试 · T2 路线图",
      perfLongContext: "长上下文衰减",
      perfLongContextNote: "需要质量评估流水线 · T2 路线图",
    },
