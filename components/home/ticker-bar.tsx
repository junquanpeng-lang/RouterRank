...
export function TickerBar() {
  ...
  // Decorative live-payment feed using real provider slugs
  const feed = useMemo(
    () => [
      { addr: "0x7a3F…e9b2", slug: "openrouter",  amt: 0.014, ago: "2s ago" },
      { addr: "agent01.eth",  slug: "bai",          amt: 0.083, ago: "5s ago" },
      { addr: "0x4D21…c0F8", slug: "easyrouter",   amt: 0.027, ago: "11s ago" },
      { addr: "kira.base.eth",slug: "openrouter",  amt: 0.142, ago: "14s ago" },
      { addr: "0x9B5e…4a17", slug: "edenai",       amt: 0.018, ago: "22s ago" },
      { addr: "0xC3a8…d901", slug: "bai",          amt: 0.236, ago: "29s ago" },
      { addr: "router-bot.eth",slug:"easyrouter",  amt: 0.041, ago: "34s ago" },
      { addr: "0x2E7d…8b44", slug: "openrouter",  amt: 0.058, ago: "48s ago" },
      { addr: "0xF1c6…3e2a", slug: "edenai",       amt: 0.092, ago: "1m ago" },
      { addr: "agent42.eth",  slug: "bai",          amt: 0.012, ago: "1m ago" },
      { addr: "0x8Ac4…5d39", slug: "easyrouter",   amt: 0.114, ago: "2m ago" },
      { addr: "pact.base.eth",slug: "openrouter",  amt: 0.064, ago: "2m ago" },
      { addr: "0x3F2b…7e15", slug: "edenai",       amt: 0.008, ago: "3m ago" },
      { addr: "0xA9d7…c23e", slug: "easyrouter",   amt: 0.031, ago: "4m ago" },
    ],
    [],
  );
